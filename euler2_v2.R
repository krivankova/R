...
mu_r<-0.02/300 #hodnota rovnovažné polohy
sigma_r<-0.02/300 #volatilita v Ornstein–Uhlenbeckovì procesu
...
matplot (t, t(vahy), type = "l", lty = 1, xlim=c(0, 300), xlab = "t", ylab = "X(t)", main = "weight of asset")
